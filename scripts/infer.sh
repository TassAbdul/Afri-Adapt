...
#SBATCH --mem=128G
#SBATCH -o Job_infer.out
#SBATCH -e Job_infer.err
#SBATCH -t 48:00:00
...
# python /gpfs/data/ceickhof/aabdul/ms-swift/data/create_infer_data.py #CREATE data
...
swift infer --adapters /gpfs/data/ceickhof/aabdul/ms-swift/output_transcribe/v0-20250424-195749/checkpoint-5960 \
             --val_dataset /gpfs/data/ceickhof/aabdul/ms-swift/data/afrivox_inference_transcribe.jsonl \
