...
#SBATCH --mem=128G
#SBATCH -o Job_NVT.out
#SBATCH -e Job_NVT.err
#SBATCH -t 24:00:00
...
swift sft \
    ...
    --dataset /gpfs/data/ceickhof/aabdul/ms-swift/data/cleaned_nv_dataset_swift_translate.jsonl\
    --train_type lora \
